...
model.add(MaxPooling2D(pool_size=(pool_size, pool_size), date_format='channels_last'))
...
model.add(Activation('relu'))
#model.add(MaxPooling2D(pool_size=(pool_size, pool_size), dim_ordering='th'))
model.add(MaxPooling2D(pool_size=(pool_size, pool_size), dim_ordering='channels_last'))
